...
| `wm/microbe_env.py` | Sandbox déterministe (cellule + énergie + nourriture) pour l'émergence. |
| `wm/emergence.py` | **Preuve** : world model **auto-supervisé** → **survie émergente** (`docs/EMERGENCE_EVIDENCE.md`). |
